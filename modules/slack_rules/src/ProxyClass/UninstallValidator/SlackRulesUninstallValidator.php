...
/**
 * This file was generated via php core/scripts/generate-proxy-class.php 'Drupal\slack_rules\UninstallValidator\SlackRulesUninstallValidator' "modules/contrib/slack/modules/slack_rules/src".
 */
...
namespace Drupal\slack_rules\ProxyClass\UninstallValidator {
    ...
    class SlackRulesUninstallValidator implements \Drupal\Core\Extension\ModuleUninstallValidatorInterface
    {
         ...
         *
         * @var \Drupal\slack_rules\UninstallValidator\SlackRulesUninstallValidator
         */
        protected $service;
