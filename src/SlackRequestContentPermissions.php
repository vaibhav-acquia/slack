...
class SlackRequestContentPermissions{
   ...
   *
   * @return array
   *   The SlackRequestContent by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (SlackRequestContent::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\slack\Entity\SlackRequestContent $type
   *   The SlackRequestContent type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(SlackRequestContent $type) {
    $type_id = $type->id();
